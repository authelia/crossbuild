...
```console
$ docker run --rm -v $(pwd):/workdir -e CROSS_TRIPLE=arm-linux-gnueabi authelia/crossbuild make helloworld
cc     helloworld.c   -o helloworld
$ file helloworld
...
```console
$ docker run --rm -v $(pwd):/workdir -e CROSS_TRIPLE=powerpc64le-linux-gnu authelia/crossbuild make helloworld
cc     helloworld.c   -o helloworld
$ file helloworld
...
```console
$ docker run --rm -v $(pwd):/workdir -e CROSS_TRIPLE=mipsel-linux-gnu authelia/crossbuild make helloworld
cc     helloworld.c   -o helloworld
$ file helloworld
...
```console
$ docker run -it --rm -v $(pwd):/workdir -e CROSS_TRIPLE=i386-apple-darwin  authelia/crossbuild make helloworld
...
```console
$ docker run -it --rm -v $(pwd):/workdir -e CROSS_TRIPLE=x86_64-apple-darwin  authelia/crossbuild make helloworld
...
```console
$ docker run -it --rm -v $(pwd):/workdir -e CROSS_TRIPLE=i686-w64-mingw32  authelia/crossbuild make helloworld
o32-clang     helloworld.c   -o helloworld
$ file helloworld
...
```console
$ docker run -it --rm -v $(pwd):/workdir -e CROSS_TRIPLE=x86_64-w64-mingw32  authelia/crossbuild make helloworld
o64-clang     helloworld.c   -o helloworld
$ file helloworld
